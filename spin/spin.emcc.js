...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_mallocTable')) {
        Object.defineProperty(Module['ready'], '_mallocTable', { configurable: true, get: function() { abort('You are getting _mallocTable on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_mallocTable', { configurable: true, set: function() { abort('You are setting _mallocTable on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_initSpinners')) {
        Object.defineProperty(Module['ready'], '_initSpinners', { configurable: true, get: function() { abort('You are getting _initSpinners on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_initSpinners', { configurable: true, set: function() { abort('You are setting _initSpinners on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_spin')) {
        Object.defineProperty(Module['ready'], '_spin', { configurable: true, get: function() { abort('You are getting _spin on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_spin', { configurable: true, set: function() { abort('You are setting _spin on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var TOTAL_STACK = 528384;
if (Module['TOTAL_STACK']) assert(TOTAL_STACK === Module['TOTAL_STACK'], 'the stack size can no longer be determined at runtime')

var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 15073280;
...
var wasmBinaryFile = 'spin.emcc.wasm';
...
var ASM_CONSTS = {
  1604: function() {throw 'Canceled!'},  
 1622: function($0, $1) {setTimeout(function() { __emscripten_do_dispatch_to_thread($0, $1); }, 0);}
};
function initPthreadsJS(){ PThread.initRuntime(); }
  ...
  var PThread={unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],initMainThreadBlock:function() {
        ...
        var pthreadMainJs = locateFile('spin.emcc.worker.js');
...
/** @type {function(...*):?} */
var _mallocTable = Module["_mallocTable"] = createExportWrapper("mallocTable");

/** @type {function(...*):?} */
var _initSpinners = Module["_initSpinners"] = createExportWrapper("initSpinners");

/** @type {function(...*):?} */
var _reset = Module["_reset"] = createExportWrapper("reset");

/** @type {function(...*):?} */
var _spin = Module["_spin"] = createExportWrapper("spin");
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 1448;
var __emscripten_main_thread_futex = Module['__emscripten_main_thread_futex'] = 14426892;
