        ...
        mkdiv("div", [
          ...
          mkdiv(
            "input",
            {
              ...
              id: "vv",
              type: "range",
              oninput: (e) => cb([midi_ch_cmds.continuous_change | idx, effects.volumecoarse, e.target.value]),
            },
          ),
          "expression",
          mkdiv("input", {
            ...
            type: "range",
            oninput: (e) =>
              cb([midi_ch_cmds.continuous_change | idx, effects.expressioncoarse, e.target.value]),
          }),
          "pan",
          mkdiv("input", {
            min: 1,
            ...
            id: "vol",
            type: "range",
            oninput: (e) => cb([midi_ch_cmds.continuous_change | idx, effects.pancoarse, e.target.value]),
          }),
        ])
      );
